...
vim.keymap.set("i", "<C-S-f>", "<Esc>:Telescope live_grep<CR>", { noremap = true, silent = true, desc = "Search in files" })
vim.keymap.set("x", "<C-S-f>", "<Esc>:Telescope live_grep<CR>", { noremap = true, silent = true, desc = "Search in files" })
