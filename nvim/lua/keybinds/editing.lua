...
map({
    ...
    { "x",               "v",                          require("lib.select_node").map("v"),             "Grow selection to the enclosing node", true },
    { "x",               "V",                          require("lib.select_node").map("V"),             "Shrink selection, or leave visual mode", true },
