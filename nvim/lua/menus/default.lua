...
return function(ctx)
    ...
    rows.item(
        ...
        ctx.symbol and ctx.supports("textDocument/definition")
    )
    rows.item(
        icons.implementation,
        "Go to implementation",
        vim.lsp.buf.implementation,
        ctx.symbol and ctx.supports("textDocument/implementation")
    )
    rows.item(
        icons.references,
        "Show references",
        vim.lsp.buf.references,
        ctx.symbol and ctx.supports("textDocument/references")
    )
    rows.item(
        icons.rename,
        "Rename symbol",
    ...
    rows.item(
        ...
        ctx.in_call and ctx.supports("textDocument/signatureHelp")
    )
