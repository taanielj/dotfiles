		...
		config = function()
			require("mason-lspconfig").setup({
				ensure_installed = {
					-- lua
					"lua_ls", -- lsp
					"stylua", -- formatter/linter
					-- Python
					-- "pylsp", -- lsp
					"pyright", -- lsp/static type checker 
					"black", -- formatter/linter
                    -- Docker and Terraform language servers
					"dockerls",
					"terraformls",
                    -- SQL
                    -- TODO: Configure SQL language servers and formatters properly for specific sql dialects
					"sqlls", -- language server
                    "sqlfmt", -- formatter
					...
					"shfm", -- formatter/linter
					-- go
					"gopls", -- official go language server for LSP supporting editors
					"golangci-lint", -- formatter/linter
				},
			})
		end,
	},
